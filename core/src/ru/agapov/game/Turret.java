...
public class Turret {
    ...
    private int cost;
    private boolean maxUpg;
   //--------------------------------
    private int level;            //adding
    public boolean isMaxUpg() {   //adding
        return maxUpg;
    }
    ...
    public void setMaxUpg(boolean maxUpg) {
        this.maxUpg = maxUpg;
    }
   ...
   //------------------------------------------
    ...
    public void activate(TurretEmitter.TurretTemplate template, int cellX, int cellY, int level) {
